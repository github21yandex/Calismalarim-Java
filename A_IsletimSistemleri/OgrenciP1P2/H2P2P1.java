...
public class H2P2P1 {
    public static void main(String[] args) throws IOException{
        ...
        H2P2Ogrenci ogrenci1 = new H2P2Ogrenci("2503", "Ayşe", "KARAKAŞ", "HUKUK" );
        ...
        try {
            ...
            H2P2Ogrenci ogrenci3 = new H2P2Ogrenci(  (H2P2Ogrenci) objectInputStream.readObject()  ); // nesne deserialization işlemine uğrar.
