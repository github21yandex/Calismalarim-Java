package A_VeriYapilari.HopScotch;
/**
...
//		System.out.println("insert :" + H.insert(3));
		...
		System.out.println("insert :" + H1.insert(63));
		System.out.println("insert :" + H1.insert(98));
		System.out.println("insert :" + H1.insert(21));
		System.out.println("insert :" + H1.insert(57));
		System.out.println("insert :" + H1.insert(84));
		System.out.println("insert :" + H1.insert(23));
		System.out.println("insert :" + H1.insert(19));
		System.out.println("insert :" + H1.insert(71));
		System.out.println("insert :" + H1.insert(5));
