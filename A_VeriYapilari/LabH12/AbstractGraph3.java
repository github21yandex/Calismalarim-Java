...
public abstract class AbstractGraph3<T> {
    /**
    ...
    public AbstractGraph3(boolean directed) {
        this();
    ...
    public abstract List<T> bfs(T baslangic);
    public abstract List<T> dfs(T baslangic);
