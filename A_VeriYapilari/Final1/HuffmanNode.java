package A_VeriYapilari.Final1;

/**
 * Huffman düğüm sınıfı. Bu sınıfın içeriğini değiştirmemeniz gerekmektedir.
 * Değişiklik yaparsanız test ortamında kodunuz beklendiği gibi çalışmayacaktır.
 */
